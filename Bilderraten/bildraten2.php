...
<style> .aufgedeckt { background-image: url("Camäleon.jpg");
 	...
 	<?php for ($row=1 ;$row<=12;$row++) {?>
		<div class="row"> 
			...
			{?>
				...
				<a href="bildraten2.php?show=<?php echo $counter?>
				"<?php if(in_array($counter,$liste))
...
<form class="mycss" action="bildraten2.php" method="POST" autocomplete="off">                                 
