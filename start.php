...
<input type="button" value="Bild1" onclick="window.location.href='http://localhost/~jansing/bildraten.php'"  class="myButton"/>
<input type="button" value="Bild2" onclick="window.location.href='http://localhost/~jansing/bildraten2.php'" class="myButton"/>
<input class="myButton" type="button" value="Bild3" onclick="window.location.href='http://localhost/~jansing/bildraten3.php'" />
</body>
